...
class BaseTestCase(TestCase):
    ...
    def setUp(self):
        ...
        db.create_all()
        # db.session.add(User("Testname","test@tester.com", "test", "WyJkdW1teWVtYWlsOEBnbWFpbC5jb20iLCJhYjAwNWRlZTAyOTlhZmY1MDA2MTY5YzQ3NTljMjE0MiJd.DaguEA.ZfHaTSUvYK4pWxSl46qXy9nErVw", "http://abc.jpg"))
